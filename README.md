...
좀 더 세세하고 다양한 기능을 구현하지 못했던  점이 아쉬웠던 것 같습니다.
...
> ➜ 재작년에 선배님들이 올려주신 오픈 소스에 있는 디자인 템플릿을 가져와 사용하게 됐는데, 사실 웹 개발할 때도 그렇지만 잘 만들어진 템플릿이 있다면
> 굳이 직접 만들지 않고 활용하는 것이 오픈 소스의 장점이라고 생각합니다.
